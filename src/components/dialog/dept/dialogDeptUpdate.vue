...
<template>
	<base-dialog v-model="model" title="修改部门" :sets="dialogSets">
		<base-form v-model="formModel" ref="formRef" :sets="formSets">
			<the-form-tree-select-lazy label="上级部门" prop="parentId" :options="optionsDeptId" :sets="setsRequired" v-if="formModel.parentId != 0"></the-form-tree-select-lazy>
			<base-form-input label="部门名称" prop="deptName" :sets="setsRequired"></base-form-input>
			<base-form-input label="部门编码" prop="dwdm" :sets="setsRequired"></base-form-input>
